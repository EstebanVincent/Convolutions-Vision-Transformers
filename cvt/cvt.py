...
class CvT(nn.Module):
    def __init__(
        ...
        ##### Stage 1 #######
        self.stage1_conv_embed = ConvolutionalTokenEmbedding(
            img_size=img_size,
        ...
        self.stage1_conv_transformer = ConvolutionalTransformerBlocks(
            dim=dim,
            img_size=img_size//4,
            depth=depth[0],
            heads=heads[0],
        ...
        dim = scale*dim
        self.stage2_conv_embed = ConvolutionalTokenEmbedding(
            img_size=img_size,
            in_channels=in_channels,
            out_channels=dim,
            kernel=kernels[1],
        ...
        self.stage2_conv_transformer = ConvolutionalTransformerBlocks(
            dim=dim,
            img_size=img_size//8,
            depth=depth[1],
            heads=heads[1],
        ...
        dim = scale * dim
        self.stage3_conv_embed = ConvolutionalTokenEmbedding(
            img_size=img_size,
            in_channels=in_channels,
            out_channels=dim,
            kernel=kernels[2],
        ...
        self.stage3_conv_transformer = ConvolutionalTransformerBlocks(
            dim=dim,
